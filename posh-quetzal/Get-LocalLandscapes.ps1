...
try {
    ...
    $copiables = $allAssets `
        ...
        | Where-Object { [long]$_.Size.Width -gt 1080 }
    ...
    if (!(Test-Path ".\Landscapes")) { 
        New-Item -Path . -Name Landscapes -ItemType Directory
    }
    ...
    $previousItems = Get-ChildItem -Path ".\Landscapes" | Select-Object *, @{n="Size";e={Get-ImageSize -Path $_.FullName}}
